...
<?php
	$connect=mysqli_connect("localhost","root","", "dahsboard");
	$select_query="SELECT * FROM `my_details`";
	$execute_query=mysqli_query($connect,$select_query);
	$query=mysqli_num_rows($execute_query);
	
	for($i=0;$i<$query; $i++);
	{
		$fatch_data=mysqli_fetch_row($execute_query);
            ...
            <main class="col-md-9">
                ...
                <div class="container">
                    <div class="dashboard-item">
                        ...
                        <p><?php echo "$fatch_data[1]"; ?></p>
                    </div>
                    <div class="dashboard-item">
                        <div id="my-skillset" class="section-title">
                            <h2>My Skillset</h2>
                        </div>
                        <p><?php echo "$fatch_data[2]"; ?></p>
                    </div>
					<?php 
	$connect=mysqli_connect("localhost","root","", "dahsboard");
	$select_query="SELECT * FROM `assignment`";
	$execute=mysqli_query($connect,$select_query);
	$query=mysqli_num_rows($execute);
	
	for($i=0;$i<$query; $i++);
	{
		$fatch=mysqli_fetch_row($execute);
...
?>
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            ...
                            <button class="ocean-blue-button gradient-button"><?php echo "<a href='$fatch[1]'>Task 1</a>";?></button>
<button class="sunset-orange-button gradient-button"><?php echo "<a href='$fatch[2]'>Task 2</a>";?></button>
<button class="spring-green-button gradient-button"><?php echo "<a href='$fatch[3]'>Task 3</a>";?></button>
